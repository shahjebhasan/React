...
class AddContact extends React.Component {
    ...
    handleAddContactFormSubmit = (e) => {
        ...
        if(this.props.isUpdating) {
            response  = this.props.updateClick({name:name, email:email, phone:phone, id:id});
        }
        else {
        ...
        <div className="border col-12 text-white p-2">
            ...
            <input name="contactId" hidden
                ...
                <div className="col-12 col-md-4 p-1">
                    <input className="form-control form-control-sm" placeholder="Name..." name="contactName" 
                    defaultValue={this.props.isUpdating ? this.props.selectedContact.name : ""}></input>
                </div> 
                <div className="col-12 col-md-4 p-1">
                ...
                <div 
                className={`col-12 p-1" ${this.props.isUpdating ? "col-md-4 offset-md-2" : "col-md-6 offset-md-3"}`}>
                ...
                <div className="col-12 col-md-4 p-1">
                    {this.props.isUpdating && (
                        ...
                        onClick={() => this.props.cancleClick()}
                        >
                            Cancel
                        </button>
                    )}
